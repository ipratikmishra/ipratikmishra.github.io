					...
					<Row>
						...
						<Col xs="12" sm="7">
							...
							<h6>
								...
								to perform diagnostics. Patient Tracker is an android
								application for doctors, designed to manage their patients in an
								efficient and easier way. Patient Tracker is everything a
								hospital record is and more. Additional abilities include
								backing up and restoring data from cloud server using DropBox
								API and sending diagnostics to patients through Whatsapp or
								Gmail intents.
							</h6>
							<br />
							<br />
							<img style={{ width: '6%' }} src={Git} />
							&nbsp;
							<a
					...
					<Row>
						...
						<Col xs="12" sm="7">
							...
							<h6>
								...
								Spark and Hadoop. Implemented Java based spark library to
								perform Geometric and Spatial operations such as spatial range,
								spatial join and spatial KNN queries on HDFS data. Implemented
								spatial join query using Cartesian Product algorithm and
								integrated into GeoSpark library. Also, Analysed different
								parameters of cluster such as execution time, average memory,
								average CPU utilization. Implemented an algorithm to identify a
								list of the fifty most statistically significant spatial
								hotspots from the collection of New York City Yellow Cab taxi
								trip data-set of January 2015 using Apache Spark.
							</h6>
							<br />
							<br />
						</Col>
